...
app = FastAPI(
    title="FarmGenius Micro-Farm ROI Predictor",
    description="Recommends the best micro-farming systems for Maharashtra smallholders based on ROI",
    version="1.0.0"
)
